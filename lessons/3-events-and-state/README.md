...
This code helped us to learn about React elements, components, and the
...
In our render method, we assigned a ref of `"form"` to the form
...
Easy enough, whenever the `NotesList` invokes the callback we provide
